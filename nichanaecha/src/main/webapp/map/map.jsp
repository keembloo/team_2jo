	...
	<div class="container-xl"> <!-- 메인 구역 -->
			...
			<div class="row optionArea py-2 m-0 mb-2 justify-content-between"> <!-- 옵션 구역 -->
				<div class="col-6 row"> <!-- 옵션 선택 박스 -->
					...
					<div class="dropdown carClass col-2"> <!-- 제조사 -->
						  ...
						  <div class="dropdown-menu dropmenu menu1 p-3">
							...
							<div class="form-check py-1">
							  <input class="form-check-input manufacturer" type="checkbox" value="현대" id="ccheck1" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input manufacturer" type="checkbox" value="기아" id="ccheck2" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input manufacturer" type="checkbox" value="르노삼성" id="ccheck3" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input manufacturer" type="checkbox" value="쉐보레" id="ccheck4" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input manufacturer" type="checkbox" value="쌍용" id="ccheck5" checked>
					...
					<div class="dropdown carClass col-2"> <!-- 차종 -->
						  <button class="dropdown-toggle dropbutton" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
						    차종
						  </button>
						  <div class="dropdown-menu dropmenu menu2 p-3">
							...
							<div class="form-check py-1">
							  <input class="form-check-input carClass" type="checkbox" value="대형" id="scheck1" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input carClass" type="checkbox" value="중형" id="scheck2" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input carClass" type="checkbox" value="준중형" id="scheck3" checked>
							...
							<div class="form-check py-1">
							  <input class="form-check-input carClass" type="checkbox" value="소형" id="scheck4" checked>
					...
					<div class="dropdown carClass col-2"> <!-- 연식 -->
						  <button class="dropdown-toggle dropbutton" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
						    연식
						  </button>
						  <div class="dropdown-menu dropmenu menu3 p-3">
							
							<input type="month" class="minMonth mx-3 mb-1 mt-1" id="customRange1-start"> 부터
							<input type="month" class="maxMonth m-3" id="customRange1-end"> 까지
							
						  </div>
					</div>
					
					<div class="dropdown carClass col-2"> <!-- 주행거리 -->
						  <button class="dropdown-toggle dropbutton" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
						    주행거리
						  </button>
						  ...
						  <div class="dropdown-menu dropmenu menu4 p-3">
							...
							<input type="range" onmousemove="minKmPrint()" step="10000" min="0" max="200000" class="minKm form-range" value="0" id="customRange1-minMileage">
					...
					<div class="dropdown carClass col-2"> <!-- 연료 -->
						  <button class="dropdown-toggle dropbutton" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
						    연료
						  </button>
						  <div class="dropdown-menu dropmenu menu5 p-3">
							...
							<div class="form-check py-1">
							  <input class="form-check-input fuelType" type="checkbox" value="휘발유" id="ccheck1" checked>
							  <label class="form-check-label" for="ccheck1">
							    휘발유
							  </label>
							</div>
							...
							<div class="form-check py-1">
							  <input class="form-check-input fuelType" type="checkbox" value="디젤" id="ccheck2" checked>
							  <label class="form-check-label" for="ccheck2">
							    디젤
							  </label>
							</div>
							...
							<div class="form-check py-1">
							  <input class="form-check-input fuelType" type="checkbox" value="LPG" id="ccheck3" checked>
							  <label class="form-check-label" for="ccheck3">
							    LPG
							  </label>
							</div>
							...
							<div class="form-check py-1">
							  <input class="form-check-input fuelType" type="checkbox" value="하이브리드" id="ccheck4" checked>
							  <label class="form-check-label" for="ccheck4">
							    하이브리드
							  </label>
							</div>
							...
							<div class="form-check py-1">
							  <input class="form-check-input fuelType" type="checkbox" value="전기" id="ccheck5" checked>
							  <label class="form-check-label" for="ccheck5">
							    전기
							  </label>
							</div>
							...
							<div class="form-check py-1">
							  <input class="form-check-input fuelType" type="checkbox" value="수소" id="ccheck5" checked>
							  <label class="form-check-label" for="ccheck5">
							    수소
							  </label>
							</div>
					...
					<div class="dropdown carClass col-2"> <!-- 가격 -->
						  <button class="dropdown-toggle dropbutton" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
						    가격
						  </button>
						  <div class="dropdown-menu dropmenu menu6 p-3">
					...
					<div class="col-3 d-flex justify-content-start">
						<button onclick="applyOptions()" type="button" class="btn optionButton1"> 옵션 적용 </button>
						<button onclick="defaultOption()" type="button" class="btn optionButton2 mx-3"> 옵션 초기화 </button>
					</div>
			
				<div class="col-3 text-end"> <!-- 검색 구역 -->
